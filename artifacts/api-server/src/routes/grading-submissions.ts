...
router.get("/grading-submissions", requireAuth, requireFeature("grading_tracker"), async (req, res) => {
...
router.post("/grading-submissions", requireAuth, requireFeature("grading_tracker"), async (req, res) => {
  const { userId } = getAuth(req);
...
router.put("/grading-submissions/:id", requireAuth, requireFeature("grading_tracker"), async (req, res) => {
  const { userId } = getAuth(req);
...
router.delete("/grading-submissions/:id", requireAuth, requireFeature("grading_tracker"), async (req, res) => {
  const { userId } = getAuth(req);
  const id = String(req.params.id);
