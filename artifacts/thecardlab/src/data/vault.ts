...
export const mockVaultItems = [
  ...
  { id: "V-002", card: "2018 Topps Update Shohei Ohtani PSA 10", insuredValue: 1100, location: "Delaware Vault", status: "Secured", image: ohtaniImg, dateStored: "2022-05-14" },
  { id: "V-003", card: "1999 Base Charizard PSA 8", insuredValue: 1200, location: "Delaware Vault", status: "Secured", image: charizardImg, dateStored: "2022-08-22" },
];
