...
const tiers = [
  ...
  },
  {
    ...
    monthly: 19,
    yearly: 190,
    blurb: "Unlimited scans. No caps. For collectors and dealers.",
    features: ["Unlimited Grade Lab scans", "Unlimited Deal Screener", "Grading Tracker", "Wantlist (unlimited)", "Priority support"],
    cta: "Unlock Unlimited — $19/mo",
    highlight: true,
    action: "pro",
  },
  {
