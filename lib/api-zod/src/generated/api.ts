...
export const GetPortfolioHistoryResponseItem = zod.object({
  ...
  "totalValue": zod.number().describe('Total portfolio value in USD at time of snapshot'),
  "createdAt": zod.string()
})
...
export const ListGradingSubmissionsResponse = zod.array(ListGradingSubmissionsResponseItem)
...
export const UpdateGradingSubmissionBody = zod.object({
  "status": zod.enum(['pending', 'in-grading', 'graded', 'shipped', 'completed']).optional(),
...
export const ListAlertsResponseItem = zod.object({
  "id": zod.string(),
  "cardName": zod.string(),
  "alertType": zod.enum(['price_drop', 'pop_update', 'market_trend']),
...
export const CreateAlertBody = zod.object({
  "cardName": zod.string(),
  "alertType": zod.enum(['price_drop', 'pop_update', 'market_trend']),
  "thresholdPrice": zod.number().optional()
})
...
export const ListWantlistItemsResponse = zod.array(ListWantlistItemsResponseItem)
...
export const AnalyzeListingResponse = zod.object({
  ...
  "condition": zod.record(zod.string(), zod.object({
  "score": zod.number(),
  "status": zod.string()
})),
